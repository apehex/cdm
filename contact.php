...
function is_recaptcha_valid($token) {
    ...
    $data = array('secret' => '6Lf4dsgUAAAAABHdiRxs-5Tg-HICgykVILfcnX7N', 'response' => $token);
    $options = array(
        'http' => array(
...
function send_mail ($name, $email, $message, $ip) {
    return mail(
        ...
        "Contact request",
        (
            "You received a message on <a href='https://moodule.github.io/cdm'>your website</a>.<br>\r\n"
            ."Ip: ".$ip."<br><br>\r\n"
            ."Name: ".$name."<br><br>\r\n"
            ."Email: ".$email."<br><br>\r\n"
